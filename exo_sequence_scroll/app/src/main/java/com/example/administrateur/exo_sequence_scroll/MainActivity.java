package com.example.administrateur.exo_sequence_scroll;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SeekBar scroll = (SeekBar) findViewById(R.id.seekBar);
        animation=(ImageView) findViewById(R.id.image);


        scroll.setOnSeekBarChangeListener(new View.OnClickListener() {
